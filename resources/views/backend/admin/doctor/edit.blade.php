...
<main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-th-list"></i> Edit Doctor</h1>
      </div>
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Doctor</li>
        <li class="breadcrumb-item active"><a href="#">Doctors Edit</a></li>
      </ul>
    </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            @if ($errors->any())
              ...
              @endif
            <h3 class="tile-title">Edit Doctor form <a class="btn btn-success float-right btn-sm" href="{{route('doctor.view')}}"><i class="fa fa-list"></i>Doctor List</a></h3>
            <div class="tile-body">
                <form method="POST" action="{{route('doctor.update',$data->id)}}" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
