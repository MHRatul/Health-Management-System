    ...
    <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
                <form method="POST" action="{{route('telemedicine.update',$data->id)}}" id="myForm" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                <div class="form-group">
                  <label class="control-label">Name <span style="color: red">*</span> </label>
                  <input class="form-control" value="{{$data->title}}" type="text" name="title" placeholder="Name" required>
                </div>
                <div class="form-group">
                  <label class="control-label">image</label>
                  <input class="form-control" type="file" name="image">
                  <img src="{{asset($data->image)}}" alt="{{$data->title}}" width="105px">
                </div>
                <div class="form-group">
